    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.POST, "/media-service/api/media/avatar/**").hasAnyRole("SELLER", "ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/media-service/api/media/avatar/**").hasAnyRole("SELLER", "ADMIN")
